...
<div class="page-container">
  <div class="container">
    ...
    <div class="tagline-block">
      ...
      <div class="tagline-bottom">The ultimate MTG Commander scheduling tool for your pod — built for smooth sessions and seamless reminders.</div>
    </div>
...
<style>
  ...
  .tagline-bottom {
    font-size: 1.1rem;
    font-weight: 400;
    margin-top: -4px; /* closes any spacing */
  }

<!-- Future Sight Dashboard Layout - Styled for Homepage Consistency -->
...
<script lang="ts">
  ...
  <style>
	main {
	  ...
	  background-image: url('https://www.transparenttextures.com/patterns/white-wall.png'), linear-gradient(135deg, #c3efff 0%, #69a8e3 40%, #2f4da1 100%);
